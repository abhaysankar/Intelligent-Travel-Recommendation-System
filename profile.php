...
?>
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
				<div class="card-body rounded-bottom bg-white p-5 col-md-5">
					<img class="img-fluid" src="uploads/<?php echo $row['image']; ?>" style="    border-radius: 10px;">
				</div>
				<div class="card-body rounded-bottom bg-white p-5 col-md-7">

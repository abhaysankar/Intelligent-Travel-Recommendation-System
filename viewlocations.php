...
<form method="post" action="itinerary.php">
        ...
        <div class="container pt-5 pb-3">
			...
			?>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        ...
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
								...
								<?php echo $row['name']; ?><?php echo $row1['name']; ?></small>
                            ...
                            <a class="h5 text-decoration-none" href="stay_single.php?id=<?php echo $row['id']; ?>"><?php echo $row['amenities']; ?></a>
					...
					<input type="radio" name="stay" value="<?php echo $row['name']; ?>">
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
			...
			?>
				...
				<input type="radio" name="attraction" value="<?php echo $row['name']  ?>">
				</a>
        ...
        <div class="container pt-5 pb-3">
			...
			?>
                <div class="col-lg-4 col-md-6 mb-4 pb-2">
					...
					<input type="radio" name="rest" value="<?php echo $row['name'];?>">
                </div>
	...
	<center><input type="submit" name="submit" class="btn btn-primary px-3"></center>
